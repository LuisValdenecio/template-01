                    ...
                    <div className="custom-screen">
                        <div className="mt-10 py-8 border-t border-gray-800 items-center justify-between sm:flex">
                            ...
                            <div className="flex items-center justify-center gap-x-6 text-gray-500 mt-6 sm:mt-0">
                                ...
                                {process.env.NEXT_PUBLIC_FOOTER_LINKEDIN_SHOW === "1" && (
                                    <Link href={process.env.NEXT_PUBLIC_FOOTER_LINKEDIN_URL} target="_blank" aria-label="social media">
                                ...
                                {process.env.NEXT_PUBLIC_FOOTER_X_SHOW === "1" && (
                                    <Link href={process.env.NEXT_PUBLIC_FOOTER_X_URL} target="_blank" aria-label="social media">
